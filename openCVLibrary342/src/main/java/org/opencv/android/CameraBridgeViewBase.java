...
//                canvas.setMatrix(mMatrix);
    ...
    /*
    Below overall code is the changes done by me munesh so if any issues then please remove the below whole code
    then the app behaves as normal as per the documentation
     */

    private void updateMatrix(){
        Log.e(TAG, "updateMatrix: called");

...
public class ProjectUtils {
    ...
    public
    static Matrix
    getTransformationMatrix(final int srcWidth, final int srcHeight, final int dstWidth,
...
// Translate back from origin centered reference to destination frame.
    ...
    public static float[] AndroidBitmapToFloatArray(Bitmap bitmap)
    {
        ...
        float[] floatArray;
        int[] intArray;
        Bitmap sampleImage = Bitmap.createScaledBitmap(bitmap, sizeX, sizeY, false).copy(Bitmap.Config.ARGB_8888, false);
        {
